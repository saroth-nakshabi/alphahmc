    ...
    <section class="breadcum">
        <div class="container">
            <div class="breadcum-content">
                ...
                <h4 class="para"><a href="index.html">Home</a> / Forgot Password</h4>
            </div>
        </div>
    </section>
    <section class="login-section">
        <div class="signin card">
            <div class="content">
                ...
                @endif
                <form class="form" id="login_form" method="post" action="{{ route('password.email') }}">
                    @csrf
                    <div class="inputBox">
                    ...
                    <div class="all-btn v2">
                        <button type="submit"
                            class="btn-p btn-blue v1 rounded">{{ __('Email Password Reset Link') }}</button>
                    </div>
                </form>
            </div>
