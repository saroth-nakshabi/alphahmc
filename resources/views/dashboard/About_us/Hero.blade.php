...
<div class="card bg-light-info shadow-none position-relative overflow-hidden">
    <div class="card-body px-4 py-3">
        <div class="row align-items-center">
            <div class="col-9">
                <h4 class="fw-semibold mb-8">About Us Hero</h4>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-3 d-flex">
                        <h5 class="mb-0">Hero Section List</h5>
...
<div class="modal fade" id="addNewModal" tabindex="-1" aria-labelledby="addNewModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
        <form class="modal-content" action="{{ route('about_us.store') }}" method="POST" id="add_form"
              enctype="multipart/form-data">
            @csrf
            <div class="modal-header d-flex align-items-center">
                <h4 class="modal-title">Add New About Us Hero Section</h4>
            ...
            <div class="modal-body">
                <div class="row pt-3">
                    <div class="col-12">
                        <div class="mb-3">
                            <label class="control-label mb-1">About Title <span class="text-danger">*</span></label>
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <textarea id="description" name="description" rows="5" class="rich-textarea form-control"
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            <label class="control-label mb-1">Background Image <span class="text-danger">*</span></label>
...
<div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
        <form class="modal-content" action="" method="POST" id="edit_form" enctype="multipart/form-data">
            @csrf
            <div class="modal-header d-flex align-items-center">
                <h4 class="modal-title">Edit About Us Hero Section</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="row pt-3">
                    <div class="col-12">
                        <div class="mb-3">
                            <label class="control-label mb-1">About Title <span class="text-danger">*</span></label>
                            <input type="text" id="edit_title" name="title" class="form-control" placeholder="About Title" required />
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            <label class="control-label mb-1">Description <span class="text-danger">*</span></label>
                            <textarea id="edit_description" name="description" rows="5" class="rich-textarea form-control"
                                      placeholder="Type here..." required></textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            <label class="control-label mb-1">About US Image</label>
...
$(document).ready(function() {
    ...
    $(document).on('click', '.edit', function() {
        ...
        $('#edit_form').attr('action', `{{ route('about_us.update', '') }}/${id}`);
        $.ajax({
            url: `{{ route('about_us.get') }}`,
            method: 'POST',
            data: { id },
            headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
            success: function(response) {
                $('#edit_form #edit_title').val(response.data.title);
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    row.html(`<td>${response.data.title}</td>
                        <td><div class="btn-group">
                            <button class="dropdown-toggle btn btn-primary btn-sm" data-bs-toggle="dropdown" data-bs-auto-close="true"><i class="bi bi-three-dots"></i></button>
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item edit" href="javascript:void(0);" data-id="${response.data.id}">Edit</a></li>
