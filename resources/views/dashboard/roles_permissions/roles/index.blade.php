...
@section('content')
    <div class="card bg-light-info shadow-none position-relative overflow-hidden">
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    <h4 class="fw-semibold mb-8">All roles</h4>
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            @can('edit roles')
                                                                <li><a class="dropdown-item edit" href="javascript:void(0);"
                                                                        data-id="{{ $role->id }}">Edit</a></li>
                                                            @endcan
                                                            @role('Admin')
                                                                <li><a class="dropdown-item"
                                                                        href="{{ route('role.permissions', $role->id) }}">Manage
                                                                        Permission</a></li>
                                                            @endrole
                                                            @can('delete roles')
                                                                <li><a class="dropdown-item delete" href="javascript:void(0);"
                                                                        data-id="{{ $role->id }}">Delete</a></li>
                                                            @endcan
                                                        </ul>
                                                    </div>
                                                </td>
    ...
    <div class="modal fade" id="addNewModal" tabindex="-1" aria-labelledby="addNewModal" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
            <form class="modal-content" action="{{ route('roles.store') }}" method="POST" id="add_form">
                ...
                <div class="modal-body">
                    ...
                    {{-- <div class="row pt-3">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="control-label mb-1">Email</label>
                                <input type="email" id="tb-email" name="tb-email" class="form-control"
                    ...
                    {{-- <div class="row pt-3">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="exampleInputPassword1" class="control-label mb-1">Password</label>
                                <input type="password" id="tb-pwd" name="tb-pwd" class="form-control"
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.edit', function() {
                ...
                const udpateUrl = `{{ route('roles.update', '') }}/${id}`;
