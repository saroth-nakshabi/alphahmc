    ...
    <div class="card bg-light-info shadow-none position-relative overflow-hidden">
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    <h4 class="fw-semibold mb-8">All Permissions</h4>
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            @can('edit permissions')
                                                                <li><a class="dropdown-item edit" href="javascript:void(0);"
                                                                        data-id="{{ $permission->id }}">Edit</a></li>
                                                            @endcan
                                                            @can('delete permissions')
                                                                <li><a class="dropdown-item delete" href="javascript:void(0);"
                                                                        data-id="{{ $permission->id }}">Delete</a></li>
                                                            @endcan
                                                        </ul>
                                                    </div>
                                                </td>
    ...
    <div class="modal fade" id="addNewModal" tabindex="-1" aria-labelledby="addNewModal" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
            <div class="modal-content">
                <form action="{{ route('roles.permissions.store') }}" method="POST" id="add_form">
                        ...
                        <div class="row pt-3">
                            <div class="col-12">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="category" class="select2 form-control" data-placeholder='select category'>
                                        <option></option>
                    ...
                    <div class="modal-body">
                        <div class="row pt-3">
                            <div class="col-12">
                                ...
                                <div class="mb-3">
                                    <label class="control-label mb-1">Category <span class="text-danger">*</span></label>
                                    <select name="category" class="select2 form-control" placeholder='select category'>
                                        <option></option>
                                        @if (isset($categories) && count($categories) > 0)
                                            @foreach ($categories as $category)
                                                <option value="{{ $category->id }}">{{ $category->name }}</option>
    ...
    <script>
        $(document).ready(function() {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            const newRow = `<tr data-id='${response.data.id}'>
                                            ...
                                            <td>${response.data.permission_category}</td>
            ...
            $(document).on('click', '.edit', function() {
                ...
                const udpateUrl = `{{ route('roles.permissions.update', '') }}/${id}`;
                $('#edit_form').attr('action', udpateUrl);

                $.ajax({
                    url: `{{ route('roles.permissions.get') }}`,
                    method: 'POST',
                    data: {
                        'id': id,
                    },
            ...
            $(document).on('click', '.delete', function() {
                const id = $(this).data('id');
                const deleteUrl = `{{ route('roles.permissions.destroy', '') }}/${id}`;
