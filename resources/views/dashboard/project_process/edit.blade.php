...
@section('content')
    <div class="card bg-light-info shadow-none position-relative overflow-hidden mb-4">
        <div class="card-body px-4 py-3">
            <h4 class="fw-semibold mb-1"><i class="ti ti-route me-2"></i>Edit Project Process</h4>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active">{{ \Illuminate\Support\Str::limit($process->name, 40) }}</li>
                </ol>
            </nav>
        </div>
    </div>
