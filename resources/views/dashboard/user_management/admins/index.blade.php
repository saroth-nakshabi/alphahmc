...
@section('content')
    <div class="card bg-light-info shadow-none position-relative overflow-hidden">
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    <h4 class="fw-semibold mb-8">All Admins</h4>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a class="text-muted " href="./index.html">Admin</a></li>
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            ...
                                                            <li><a class="dropdown-item edit" href="javascript:void(0);"
                                                                    data-id="{{ $admin->id }}">Edit</a></li>
                                                            @endcan
                                                            @can('delete admins')
                                                            <li><a class="dropdown-item delete" href="javascript:void(0);"
                                                                    data-id="{{ $admin->id }}">Delete</a></li>
                                                            @endcan
                                                        </ul>
                                                    </div>
                                                </td>
    ...
    <div class="modal fade" id="addNewModal" tabindex="-1" aria-labelledby="addNewModal" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
            <form class="modal-content" action="{{ route('admins.store') }}" method="POST" id="add_form">
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.edit', function() {
                ...
                const udpateUrl = `{{ route('admins.update', '') }}/${id}`;
                $('#edit_form').attr('action', udpateUrl);

                $.ajax({
                    url: `{{ route('admins.get') }}`,
                    method: 'POST',
                    data: {
                        'id': id,
                    },
            ...
            $(document).on('click', '.delete', function() {
                const id = $(this).data('id');
                const deleteUrl = `{{ route('admins.destroy', '') }}/${id}`;
